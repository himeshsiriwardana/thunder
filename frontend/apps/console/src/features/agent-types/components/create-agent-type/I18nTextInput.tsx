...
function I18nContent({
  ...
  const handleCreate = useCallback(() => {
    if (!newKey.trim()) {
      setError(t('agentTypes:displayNameI18n.keyRequired', 'Translation key is required'));
      return;
    }
    if (!newValue.trim()) {
      setError(t('agentTypes:displayNameI18n.valueRequired', 'Translation value is required'));
      return;
    }
      ...
      <Box sx={{display: 'flex', flexDirection: 'column', gap: 2}}>
        ...
        <div>
          <Typography variant="subtitle2" gutterBottom>
            {t('agentTypes:displayNameI18n.language', 'Language')}
          </Typography>
          <Autocomplete
        ...
        <div>
          <Typography variant="subtitle2" gutterBottom>
            {t('agentTypes:displayNameI18n.i18nKey', 'Translation Key')}
          </Typography>
          <TextField
            fullWidth
            size="small"
        ...
        <div>
          <Typography variant="subtitle2" gutterBottom>
            {t('agentTypes:displayNameI18n.translationValue', 'Translation Value')}
          </Typography>
          <TextField
            fullWidth
            size="small"
  ...
  return (
    <Box sx={{display: 'flex', flexDirection: 'column', gap: 2}}>
      <div>
        ...
        <Autocomplete
          ...
          renderInput={(params: AutocompleteRenderInputParams) => (
            <TextField
              {...params}
              placeholder={t('agentTypes:displayNameI18n.selectKey', 'Select a translation key')}
              size="small"
            />
          )}
      ...
      {i18nKey && resolvedValue && (
        ...
        >
          <Typography variant="caption" color="text.secondary" sx={{display: 'block', mb: 0.5}}>
            {t('agentTypes:displayNameI18n.resolvedValue', 'Resolved value')}
          </Typography>
      ...
      <Box sx={{display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
        <Tooltip title={t('agentTypes:displayNameI18n.createTooltip', 'Create a new translation key')}>
          <Button variant="text" startIcon={<PlusIcon size={16} />} onClick={() => onCreateModeChange(true)}>
            {t('agentTypes:displayNameI18n.createTitle', 'Create New Translation')}
          </Button>
        </Tooltip>
      </Box>
    </Box>
      ...
      <Card sx={{width: 400}}>
        <CardHeader
          title={
            isCreateMode
              ? t('agentTypes:displayNameI18n.createTitle', 'Create New Translation')
              : t('agentTypes:displayNameI18n.title', 'Translation')
          }
          action={
        ...
        InputProps={{
          endAdornment: (
            <InputAdornment position="end">
              <Tooltip title={t('agentTypes:displayNameI18n.tooltip', 'Configure translation')}>
                <IconButton
                  ref={setIconButtonEl}
