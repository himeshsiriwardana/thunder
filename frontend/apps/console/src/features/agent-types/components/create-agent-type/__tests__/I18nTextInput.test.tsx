...
describe('I18nTextInput', () => {
  ...
  it('shows resolved value when input has an i18n template', () => {
    ...
    expect(screen.getByText('agentTypes:displayNameI18n.resolvedValue')).toBeInTheDocument();
  ...
  it('opens popover and enters create mode', async () => {
    ...
    await user.click(screen.getByText('agentTypes:displayNameI18n.createTitle'));
