...
const sidebars: SidebarsConfig = {
  docsSidebar: [
    ...
    // Deployment Patterns Section
    {
      ...
      className: 'sidebar-html-section-header sidebar-persona-devops',
    },
    {
      type: 'category',
      ...
      collapsed: false,
      collapsible: false,
      className: 'sidebar-section sidebar-persona-devops',
      items: [
        {
          type: 'doc',
